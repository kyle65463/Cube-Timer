...
void main() {
  test('Test ao5 under normal situation', () async {
    ...
    int result = StatUtils.ao5(nums);
    expect(result, 5);

    nums = [111, 312312331, 30, 40, 5231313123, 60, 70];
    result = StatUtils.ao5(nums);
  ...
  test('Test ao12 under normal situation', () async {
    ...
    int result = StatUtils.ao12(nums);
    expect(result, 6); // (2 + ... + 10) / 9 = 6

    nums.shuffle();
    result = StatUtils.ao12(nums);
    expect(result, 6);
  ...
  test('Best', () async {
    List<int> nums = [1, 2, 3, 4, 5, 6, 7, 8, 9, -1, -1, -1];
    int result = StatUtils.best(nums);
    expect(result, 1);

    nums.shuffle();
    result = StatUtils.best(nums);
    expect(result, 1);
